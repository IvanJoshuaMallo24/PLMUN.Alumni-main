...
<div class="container">
    ...
    <div class="filter-container">
        <form method="POST" action="">
            ...
            <a href="alumni_dashboard.php" class="button" style="margin-left: 10px;">All Alumni</a>
        </form>
    </div>
    ...
    <div style="text-align: center; margin-top: 20px;">
        ...
        for ($i = 1; $i <= $totalPages; $i++) {
            echo '<a href="?page=' . $i . '" class="button" ' . ($i == $page ? 'style="background-color: #004d00;"' : '') . '>' . $i . '</a>';
        }
        ?>
...
function updateDepartmentOptions() {
    // Implementation for dynamically updating department options based on selected college
}

function updateSectionOptions() {
    // Implementation for dynamically updating section options based on selected department
}
</script>
